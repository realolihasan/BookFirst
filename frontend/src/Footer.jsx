 ...
 return (
   <footer className="bg-gray-900 text-white">
     <div className="container mx-auto px-[50px] py-8">
       ...
       <div className="grid grid-cols-4 grid-rows-2 gap-8 items-start">
  ...
  {/* Row 1, Column 3: Navigation Links */}

  <div></div>

  {/* Row 1, Column 4: User's Name (bottom aligned) */}
  <div className="flex items-end h-full">
    {user && <span className="text-gray-400">{user.name}</span>}
  </div>
  
  {/* Row 2, Column 1: Empty to align with brand */}
  ...
  {/* Row 2, Column 3: Policy Links */}
  <div className="flex flex-col space-y-2">
    <FooterLink to="/privacy-policy">Privacy Policy</FooterLink>
    <FooterLink to="/terms-of-service">Terms of Service</FooterLink>
  </div>
  
  {/* Row 2, Column 4: User Actions */}
  <div className="flex flex-col space-y-4">
    {user ? (
      <>
